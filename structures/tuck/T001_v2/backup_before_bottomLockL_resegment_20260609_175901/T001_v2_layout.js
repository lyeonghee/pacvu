...
function T001_v2_buildBleedPath(spec, grid) {
  ...
  function bottomLockLBleed() {
    ...
    const midNudge = Math.max(0, (D - 57) * (4 / 143));
    const exitNudge = Math.max(0, (D - 57) * (7 / 143));
    return [
      'M ' + P(bottomLockLStart.x, bottomLockLStart.y),
      'C ' + P(r1.x + curveStartDx, r1.y + curveStartDy) + ' ' + P(r2.x - 2.650 + midNudge * 0.45, r2.y + 0.400) + ' ' + P(r3.x - 2.350 + midNudge, r3.y + 1.300),
      'C ' + P(r4.x - 1.900 + midNudge, r4.y + 2.100) + ' ' + P(r5.x - 0.950 + exitNudge * 0.75, r5.y + 2.900) + ' ' + P(r6.x + 0.044 + exitNudge, r6.y + b),
