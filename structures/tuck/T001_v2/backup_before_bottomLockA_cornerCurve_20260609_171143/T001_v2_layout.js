...
function T001_v2_buildBleedPath(spec, grid) {
  ...
  function bottomLockLBleed() {
    ...
    return [
      'M ' + P(r0.x - 2.819, r0.y - 0.898),
      'C ' + P(r1.x - 3.102, r1.y + 0.005) + ' ' + P(r2.x - 2.934, r2.y + 1.013) + ' ' + P(r3.x - 2.375, r3.y + 1.774),
      'C ' + P(r4.x - 1.815, r4.y + 2.537) + ' ' + P(r5.x - 0.910, r5.y + b) + ' ' + P(r6.x + 0.044, r6.y + b),
  ...
  function bottomLockRBleed() {
    ...
    return [
      ...
      'C ' + P(r4.x + 3.029, r4.y + 0.992) + ' ' + P(r5.x + 3.190, r5.y - 0.022) + ' ' + P(r6.x + 2.896, r6.y - 0.927),
  ...
  function thumbNotchBleed() {
    return [
      'L ' + P(xNeckR, yLF - b),
      'L ' + P(xNotchInnerR + 0.182, yNotchEntry),
      'L ' + P(xNotchInnerR, yLF - 0.352),
      'C ' + P(xNotchInnerR - 0.295, yNotchShoulder) + ' ' + P(xNotchInnerR - S(2.883), yNotchMid) + ' ' + P(xNeckC, yNotchMid),
      'C ' + P(xNotchInnerL + S(2.973), yNotchMid) + ' ' + P(xNotchInnerL + 0.385, yNotchShoulder) + ' ' + P(xNotchInnerL, yLF - 0.352),
      'L ' + P(xNotchInnerL, yNotchEntry + 0.102),
      'L ' + P(xNeckL, yLF - b)
    ];
  }
  ...
  function lidSideFlapLBleed() {
    return [
      ...
      'L ' + P(sfLFlatR - 2.318, yLSFTop - b),
      'L ' + P(sfLFlatR - 2.318, yTF)
    ];
  }
  ...
  function bottomLockABleed() {
    const leftBottom = pt(xP1 + lockAInnerX - b - 0.954, yLO + b);
    const leftCp1 = pt(xP1 + lockAInnerX - 0.095, yLO + b);
    const leftCp2 = pt(xP1 + lockAInnerX + 3.045, yLO - 0.140);
    const leftInner = pt(xP1 + lockAInnerX + 3.045, yBVert);
    const leftTop = pt(xP1 + lockAInnerX + 3.045, yLRFlat + b);

    const rightTop = pt(xP2 - lockAInnerX - 2.955, yLRFlat + b);
    const rightInner = pt(xP2 - lockAInnerX - 2.955, yBVert);
    const rightCp1 = pt(xP2 - lockAInnerX - 2.955, yLO - 0.141);
    const rightCp2 = pt(xP2 - lockAInnerX + 0.185, yLO + b);
    const rightBottom = pt(xP2 - lockAInnerX + b + 1.045, yLO + b);
    ...
    return [
      ...
      'L ' + P(rightOuterBleedX, yLO + b),
      'L ' + P(rightOuterBleedX, yBB + lockStep + 1.242),
      'L ' + P(rightOuterBleedX + 0.490, yBB + lockStep + 0.798),
