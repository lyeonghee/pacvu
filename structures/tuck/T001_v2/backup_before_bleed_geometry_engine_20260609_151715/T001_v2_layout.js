...
function T001_v2_buildBleedPath(spec, grid) {
  ...
  function bottomLockLBleed() {
    return [
      'M ' + P(xP2 + S(25.268), yLRFlat - S(4.796)),
      'C ' + P(xP2 + S(24.699), yLRFlat - S(2.980)) + ' ' + P(xP2 + S(25.031), yLRFlat - S(0.981)) + ' ' + P(xP2 + S(26.156), yLRFlat + S(0.550)),
      'C ' + P(xP2 + S(27.282), yLRFlat + b - S(0.916)) + ' ' + P(xP3 - S(27.910), yLRFlat + b) + ' ' + P(xP3 - S(26.007), yLRFlat + b),
      'L ' + P(xP3 - S(25.224), yLRFlat + b),
      'L ' + P(xP3, yLRFlat + b),
      'L ' + P(xP3, yBB + b + 2.509)
    ];
  }
  ...
  function bottomLockRBleed() {
    return [
      'L ' + P(xP4 + S(26.164), yLRFlat + b),
      'C ' + P(xEnd - S(27.427), yLRFlat + b) + ' ' + P(xEnd - S(25.612), yLRFlat + b - S(0.924)) + ' ' + P(xEnd - S(24.486), yLRFlat + S(0.527)),
      'C ' + P(xEnd - S(23.361), yLRFlat - S(1.021)) + ' ' + P(xEnd - S(23.042), yLRFlat - S(3.033)) + ' ' + P(xEnd - S(23.633), yLRFlat - S(4.853)),
      'C ' + P(xEnd - S(24.224), yLRFlat - S(6.673)) + ' ' + P(xEnd - S(24.894), yLRFlat - S(8.737)) + ' ' + P(xEnd - S(24.894), yLRFlat - S(8.737)),
  ...
  function sideRAndLidSideFlapRBleed() {
    return [
      ...
      'L ' + P(xEnd + 0.477, yLF - b - 0.807),
      'L ' + P(xEnd - 0.949, yLSFTop - b),
      'L ' + P(sfRFlatL - b, yLSFTop - b),
      'C ' + P(xP4 + S(10.823), yLSFTop - b) + ' ' + P(xP4 + S(7.645), yLSFTop - S(0.562)) + ' ' + P(xP4 + S(6.710), yLSFTop + S(2.929)),
      'L ' + P(xP4 + S(3.355), yLF - b - S(9.553)),
      'L ' + P(xP4 - 0.955, yLF - b - S(5.243)),
      'L ' + P(xP4 - 0.955, yLF - b)
    ];
  }
  ...
  function thumbNotchBleed() {
    return [
      'L ' + P(xNeckR, yLF - b),
      'L ' + P(lbGapR + 0.182, yLF - b),
      'L ' + P(lbGapR, yLF - 0.352),
      'C ' + P(lbGapR - 0.295, yLF + S(2.699)) + ' ' + P(lbGapR - S(2.883), yLF + S(5.000)) + ' ' + P(lbGapR - S(5.955), yLF + S(5.000)),
      'C ' + P(lbGapL + S(2.973), yLF + S(5.000)) + ' ' + P(lbGapL + 0.385, yLF + S(2.699)) + ' ' + P(lbGapL, yLF - 0.352),
      'L ' + P(lbGapL, yLF - b + 0.102),
      'L ' + P(xNeckL, yLF - b)
    ];
  }
  ...
  function lidSideFlapLBleed() {
    return [
      'L ' + P(xP3 + 1.045, yLF - b),
      'L ' + P(xP3 + 1.045, yLF - b - S(5.243)),
      'L ' + P(xP3 - S(3.265), yLF - b - S(9.554)),
      'L ' + P(xP3 - S(6.619), yLSFTop + S(2.929)),
      'C ' + P(xP3 - S(7.555), yLSFTop - S(0.562)) + ' ' + P(xP3 - S(10.732), yLSFTop - b) + ' ' + P(xP3 - S(14.346), yLSFTop - b),
      'L ' + P(xP2 + 3.046, yLSFTop - b),
      'L ' + P(xP2 + 3.046, yTF)
    ];
  }
  ...
  function bottomLockABleed() {
    return [
      'L ' + P(xP1 + lockAInnerX - b - 0.954, yLO + b),
      'C ' + P(xP1 + lockAInnerX - 0.095, yLO + b) + ' ' + P(xP1 + lockAInnerX + 3.045, yLO - 0.140) + ' ' + P(xP1 + lockAInnerX + 3.045, yBVert),
      'L ' + P(xP1 + lockAInnerX + 3.045, yLRFlat + b),
      'L ' + P(xP2 - lockAInnerX - 2.955, yLRFlat + b),
      'L ' + P(xP2 - lockAInnerX - 2.955, yBVert),
      'C ' + P(xP2 - lockAInnerX - 2.955, yLO - 0.141) + ' ' + P(xP2 - lockAInnerX + 0.185, yLO + b) + ' ' + P(xP2 - lockAInnerX + b + 1.045, yLO + b),
      'L ' + P(xP2, yLO + b),
      'L ' + P(xP2, yBB + b + 1.242),
      'L ' + P(xP2 + 0.490, yBB + b + 0.798),
      'L ' + P(xP2 + S(26.484), yLRFlat - S(8.672)),
      'L ' + P(xP2 + S(25.269), yLRFlat - S(4.797))
    ];
  }
